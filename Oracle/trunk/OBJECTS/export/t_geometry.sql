...
CREATE OR REPLACE EDITIONABLE TYPE "&&INSTALL_SCHEMA."."T_GEOMETRY" 
AUTHID DEFINER
AS OBJECT (
...
******/
  ...
  *  NAME
  *    ST_AsWKT -- Exports mdsys.sdo_geometry object to its Extended Well Known Text (WKT)
  *  SYNOPSIS
  *    Member Function ST_AsWKT
  *             Return clob Deterministic,
  *  DESCRIPTION
  *    Returns Extended Well Known Text representation of underlying mdsys.sdo_geometry.
  *    Supports 2D/3D/4D geometry objects.
  *  RESULT
  *    EWKT (CLOB) -- eg Extended Well Known Text encoding of mdsys.sdo_geometry object.
  *  EXAMPLE
  *    with data as (
