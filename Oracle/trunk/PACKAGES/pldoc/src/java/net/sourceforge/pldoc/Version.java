...
* @version $Header: /cvsroot/pldoc/sources/src/java/net/sourceforge/pldoc/Version.java,v 1.1 2003/10/19 16:27:33 altumano Exp $
*/
public class Version {

  // the Name will be substituted with release tag by CVS 
  private static final String tagName = "$Name: release0831 $";
