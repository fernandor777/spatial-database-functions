...
public class OraWriter 
{
  ...
  public STRUCT write(Geometry geom, OracleConnection connection) throws SQLException
  {
    ...
    if (oraGeom.point == null) {
      ...
      Datum data[] = new Datum[] {
                OraUtil.toNUMBER(oraGeom.point[0]), OraUtil.toNUMBER(oraGeom.point[1]),
  ...
  /**
     * Creates an {@link org.locationtech.jts.io.oracle.OraGeom} structure corresponding to the Oracle SDO_GEOMETRY
  ...
  private int writeElement(Geometry geom, int dim, int offset, List elemTriplets, List ordGeoms)
  {
    ...
    case org.locationtech
      ...
      Point point = (Point) geom;
      elemTriplets.add(triplet(offset, org.locationtech
                                                .jts
                                                .io
                                                .oracle
                                                .OraGeom
                                                .ETYPE
                                                .POINT, org.locationtech
                                                           .jts
                                                           .io
                                                           .oracle
                                                           .OraGeom
    ...
    case org.locationtech
      ...
      interp = isWriteAsRectangle(polygon) ? org.locationtech
                                                      .jts
                                                      .io
                                                      .oracle
                                                      .OraGeom
                                                      .INTERP
                                                      .RECTANGLE : org.locationtech
                                                                      .jts
                                                                      .io
                                                                      .oracle
                                                                      .OraGeom
      ...
      elemTriplets.add(triplet(offset, org.locationtech
                                                ...
                                                .OraGeom
                                                .ETYPE
                                                .POLYGON_EXTERIOR, interp));
      ordGeoms.add(ring);
      if (interp == org.locationtech
                             .jts
                             .io
                             .oracle
                             .OraGeom
      ...
      for (int i = 0; i < holes; i++) {
        ...
        elemTriplets.add(triplet(offset, org.locationtech
                                                    ...
                                                    .OraGeom
                                                    .ETYPE
                                                    .POLYGON_INTERIOR, org.locationtech
                                                                          .jts
                                                                          .io
                                                                          .oracle
                                                                          .OraGeom
