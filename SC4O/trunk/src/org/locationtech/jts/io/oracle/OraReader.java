   ...
   * @throws IllegalArgumentException if an unsupported geometry type or encoding error is found
	...
	public Geometry read(STRUCT struct) throws SQLException 
	{
		...
		double ordinates[] = OraUtil.toDoubleArray((ARRAY) data[4], Double.NaN);
                if ( point == null && elemInfo==null && ordinates==null ) {
                    throw new IllegalArgumentException("SDO_GEOMETRY with NULL elements detected.");
                }
   ...
   */
    private GeometryCollection readCollection(OraGeom oraGeom) 
    {
      ...
      for (int i = 0; cont && i < nElem; i++) {
        ...
        case org.locationtech
                    ...
                    .ETYPE
                    .POINT:
            if (interpretation == org.locationtech
                                         .jts
                                         .io
                                         .oracle
                                         .OraGeom
    ...
    private MultiPolygon readMultiPolygon(OraGeom oraGeom)
    {
      ...
      for (int i = 0; i < nElem; i++) {
        int etype = oraGeom.eType(i);
        if ((etype == org.locationtech
                             .jts
                             .io
                             .oracle
                             .OraGeom
                             .ETYPE
                             .POLYGON) || (etype == org.locationtech
                                                       .jts
                                                       .io
                                                       .oracle
                                                       .OraGeom
    ...
    private MultiPoint readMultiPoint(OraGeom oraGeom, int elemIndex) 
    {
       ...
       */
      if (oraGeom.geomType() == org.locationtech
                                     .jts
                                     .io
                                     .oracle
                                     .OraGeom
        ...
        checkETYPE(etype, org.locationtech
                                 .jts
                                 .io
                                 .oracle
                                 .OraGeom
    ...
    private Polygon readPolygon(OraGeom oraGeom, int elemIndex) 
    {
      ...
      int interpretation = oraGeom.interpretation(elemIndex);
    	...
    	checkInterpretation(interpretation, org.locationtech
                                               .jts
                                               .io
                                               .oracle
                                               .OraGeom
      ...
      for (int i = elemIndex + 1; i < nElem; i++) {
        ...
        else if (etype == org.locationtech
                                   .jts
                                   .io
                                   .oracle
                                   .OraGeom
      ...
      int interpretation = oraGeom.interpretation(elemIndex);
    	...
    	checkETYPE(etype, org.locationtech
                             ...
                             .POLYGON, org.locationtech
                                          ...
                                          .OraGeom
                                          .ETYPE
                                          .POLYGON_EXTERIOR, org.locationtech
                                                                .jts
                                                                .io
                                                                .oracle
                                                                .OraGeom
