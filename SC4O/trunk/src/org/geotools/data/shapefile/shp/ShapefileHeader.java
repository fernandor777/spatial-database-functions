 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.5/modules/plugin/shapefile/src/main/java/org/geotools/data/shapefile/shp/ShapefileHeader.java $
 */
public class ShapefileHeader {
  ...
  private void checkMagic(boolean strict) 
  ...
  public void read(ByteBuffer file,boolean strict) throws java.io.IOException {
    ...
    public void write(ByteBuffer _file,
                      ShapeType  _type,
                      int        _length,
                      Envelope   _envelope)
    throws IOException 
