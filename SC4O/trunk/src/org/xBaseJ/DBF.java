...
public class DBF extends Object {
    ...
    public DBF(String DBFname, DBFTypes format, boolean destroy) throws xBaseJException, IOException,
                                                                        SecurityException {
    ...
    protected void createDBF(String DBFname, DBFTypes format, boolean destroy) throws xBaseJException, IOException,
                                                                                      SecurityException {
        jNDX = null;
        jNDXes = new Vector<Index>(1);
        jNDXID = new Vector<String>(1);
