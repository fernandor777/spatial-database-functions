...
public class DateField extends Field {
    ...
    public DateField(String iName, RandomAccessFile infile) throws xBaseJException {
        super();
        super.setField(iName, 8, infile);
    }
    ...
    public DateField(String iName) throws IOException, xBaseJException {
        super();
        super.setField(iName, 8, (RandomAccessFile) null);
        put("");
    }

    public DateField() throws xBaseJException {
        Length = 8;
    ...
    public void put(String inValue) throws xBaseJException {
        ...
        for (i = 0; i < 8; i++) {
            if (Character.isDigit(inValue.charAt(i)) == false) {
                throw new xBaseJException("Invalid format for date Field, " + inValue + " non numeric at position " +
                                          i);
            }
        }
