...
public class DBF extends Object {
    ...
    public DBFTypes version = DBFTypes.DBASEIII;
    ...
    public DBF(String DBFname, DBFTypes format, boolean destroy) throws xBaseJException, IOException, SecurityException
    ...
    public DBF(String DBFname, DBFTypes format, boolean destroy, String inEncodeType) throws xBaseJException,
    ...
    public void openDBF(String DBFname) throws IOException, xBaseJException {
        ...
        if ((version != DBFTypes.DBASEIII) && (version != DBFTypes.DBASEIII_WITH_MEMO) &&
            ...
            throw new xBaseJException("Wrong Version " + version.toString());
        }
    ...
    public void createDBF(String DBFname, DBFTypes format, boolean destroy) throws xBaseJException, IOException,
                                                                                   SecurityException {
        ...
        if (format != DBFTypes.DBASEIII && format != DBFTypes.DBASEIII_WITH_MEMO)
            MDX_exist = 1;
    ...
    public void db_offset(DBFTypes format, boolean memoPresent) {
    ...
    public void read_dbhead() throws IOException {
        ...
        file.seek(0);
        version = DBFTypes.getDBFType(file.readByte());
    ...
    public void setVersion(int b) {
        version = DBFTypes.getDBFType((byte) b);
    }
