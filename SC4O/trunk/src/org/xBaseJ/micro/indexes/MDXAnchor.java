...
static final short BLOCKLENGTH = 512;
  ...
  public short indexes;        /* number of Indexes in the file        */
  byte resrvd2[] = new byte[2];
  int next_available;        /* page number of end of file           */
...
public int get_nextavailable() { return next_available; }

public void update_nextavailable()  throws IOException
{
next_available += blocksize;
write();
}
