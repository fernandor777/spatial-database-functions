...
public class DBT_fpt extends DBTFile {
    ...
    public byte[] readBytes(byte[] input) throws IOException, xBaseJException {
        ...
        file.skipBytes(4); // skip the field type identifier
    ...
    public byte[] write(byte inBytes[], int originalSize, boolean write, byte originalPos[]) throws IOException,
                                                                                                    xBaseJException {
        ...
        if (inBytes.length == 0) {
            byte breturn[] = {
                BYTESPACE, BYTESPACE, BYTESPACE, BYTESPACE, BYTESPACE, BYTESPACE, BYTESPACE, BYTESPACE, BYTESPACE,
                BYTESPACE
            };
            return breturn;
        }
