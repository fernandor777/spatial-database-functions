...
public abstract class DBTFile extends Object {
    ...
    public void rename(String name) throws IOException {
        ...
        String tname = name.substring(0, name.length() - 1) + "t";
    ...
    throws IOException, xBaseJException, IOException {
        ...
        if (type == DBFTypes.FOXPRO_WITH_MEMO) {
            extension = "fpt";
            tname = name.substring(0, name.length() - 3) + extension;
            ...
            thefile = new File(tname);
            if (!thefile.exists() || !thefile.isFile()) {
                String dtname = name.substring(0, name.length() - 3) + "fpt";
    ...
    public abstract byte[] write(String value, int originalSize, boolean write, byte originalPos[]) throws IOException,
                                                                                                           xBaseJException;
