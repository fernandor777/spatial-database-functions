 ...
 * 
 */
public class JASPAIllegalArgumentException extends JASPAException {

	private static final long serialVersionUID = 1L;

	public JASPAIllegalArgumentException(String message) {

		super(message);
	}

	public JASPAIllegalArgumentException(Exception e) {
