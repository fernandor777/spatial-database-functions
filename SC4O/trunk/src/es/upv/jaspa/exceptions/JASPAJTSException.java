...
/**
 * @author Jose Martinez-Llario JTS throws several unchecked exceptions: IllegalArgumentExcpetion
 *         (Geometry factories, null geometries,etc.) AssertionFailedException (runtime
 *         inconsistencies)
 * 
 *         JASPA wraps these exceptions using the checked exception JASPAJTSException
 */
public class JASPAJTSException extends JASPAException {

	private static final long serialVersionUID = 1L;

	public JASPAJTSException(String message) {

		super(message);
	}

	public JASPAJTSException(Exception e) {
