...
import com.spdba.dbutils.io.IOConstants.SHAPE_TYPE;
 ...
 *
 */
public class WriteTABFile {

    public  static     String        MI_PRINX = "MI_PRINX";
        ...
        try {
            for (int i = 1; i <= _metaData.getColumnCount(); i++) {
                if (_metaData.getColumnType(i) == OracleTypes.STRUCT &&
                    ...
                    String colName =
                        Strings.isEmpty(_metaData.getCatalogName(i)) 
     ...
     * <p>
     * Writes the given result as shape files with TAB file 
     *  
     ...
     * @param _coordString - A MapInfo CoordSys string for writing to TAB file parameter. 
     * @param _symbolisationString - A MapInfo Brush etc symblisation string for rendering of TAB file data. 
    ...
    public static void write(java.sql.ResultSet _resultSet, 
                             ...
                             java.lang.String   _coordSysString,
                             java.lang.String   _symbolisationString,
    ...
    {  
        ...
        ShapeType sType = SHAPE_TYPE.validateShapeType(_shapeType);
        ...
        TABExporter geoExporter;
        String fullFileName = FileUtils.FileNameBuilder(_outputDirectory,_fileName,"shp");
        geoExporter = new TABExporter(DBConnection.getConnection(),
                                      fullFileName,
        ...
        geoExporter.setCoordSysString(_coordSysString);
        geoExporter.setSymbolisationString(_symbolisationString);
        ...
        geoExporter.setRecordIdentifier(geoExporter.hasAttributes() ? null : MI_PRINX);
        ...
        try {
            ...
            e.printStackTrace();
            LOGGER.info("WriteSHPFile: Error Writing Tabbed hapefile (" + e.getLocalizedMessage() + ")");
        }
    }
