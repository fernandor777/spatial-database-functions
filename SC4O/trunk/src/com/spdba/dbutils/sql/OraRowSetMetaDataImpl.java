...
public class OraRowSetMetaDataImpl implements RowSetMetaData {

    public OraRowSetMetaDataImpl() {
        super();
    }
    ...
    private void checkColType(int SQLType) throws SQLException {
        try {
            ...
            c = oracle.jdbc.OracleTypes.class;
    ...
    public String getColumnClassName(int columnIndex) throws SQLException {
        String className = "".getClass().getName(); // Default for all string types
        ...
        case Types.DECIMAL:
            ...
            break;
        case Types.BIT:
            className = (Boolean.valueOf(false)).getClass().getName();
            break;
        case Types.TINYINT:
        ...
        case OracleTypes.ARRAY:
            className = "oracle.sql.ARRAY";
            break;
        case OracleTypes.BINARY_DOUBLE:
            className = (new oracle.sql.BINARY_DOUBLE(123456)).getClass().getName();
            break;
        case OracleTypes.BINARY_FLOAT:
            className = (new oracle.sql.BINARY_FLOAT(123456)).getClass().getName();
            break;
        case OracleTypes.BFILE:
            className = (new oracle.sql.BFILE(null)).getClass().getName();
            break;
        case OracleTypes.INTERVALDS:
            className = (new oracle.sql.INTERVALDS("3 2:25:45.0")).getClass().getName();
            break;
        case OracleTypes.INTERVALYM:
            className = (new oracle.sql.INTERVALYM("1-3")).getClass().getName();
            break;
        case OracleTypes.TIMESTAMPTZ:
            className = (new oracle.sql.TIMESTAMPTZ(null)).getClass().getName();
            break;
        case OracleTypes.TIMESTAMPLTZ:
            className = (new oracle.sql.TIMESTAMPLTZ(null)).getClass().getName();
            break;
        case OracleTypes.STRUCT:
            className = "oracle.sql.STRUCT";
            break;
        }
