...
public class Strings {
    ...
    /**
   * append
   * Appends two non-null strings togther with separator if required
   * @param a - First String (can be null)
   * @param b - Second String to be appended to a (first string)
   * @param separator - separator between a and b (could be null , - : etc)
