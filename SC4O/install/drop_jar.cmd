...
ECHO Dropping %JARFILE% classes ...
dropjava -verbose -force -oci -stdout -user %ousr%/%opwd%@//%ohost%:%oport%/%osid% %JARFILE% > log/drop_%JARFILE%.log
GOTO SUCCESS
...
:USAGE
ECHO usage: drop_jar JARFILE ORACLE_HOME username password host port SID 
